...
#define GES_SHAKE_THR       500.0f//2000.0f
#define GES_TURN_THR        200.0f//800.0f
#define GES_SHAKE_LEN_THR   10//20
...
/**
 * @brief judge the type of gesture判断手势的类型
 * @param[in] none
 * @return gesture type
 */
...
/**
 * @brief recognize the direction of the shaking gesture识别摇晃手势的方向
 * @param[in] none
 * @return gesture code
 */
